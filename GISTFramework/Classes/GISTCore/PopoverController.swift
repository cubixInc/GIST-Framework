...
open class PopoverController: UIViewController {
    ...
    private func updateArrow() {
        ...
        case UIPopoverArrowDirection.up:
            ...
            self.arrowView.transform = CGAffineTransform(rotationAngle: degreestoradians(180));
            break;
        ...
        case UIPopoverArrowDirection.left:
            ...
            self.arrowView.transform = CGAffineTransform(rotationAngle: degreestoradians(90));
            break;
