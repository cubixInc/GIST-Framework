...
struct AnimatedTextInputFieldConfigurator {

    enum AnimatedTextInputType:String {
        case standard
        case multiline
    }
...
//        case .password:
//            return AnimatedTextInputPasswordConfigurator.generate(toggleable: false)
//        case .passwordToggleable:
//            return AnimatedTextInputPasswordConfigurator.generate(toggleable: true)
//        case .numeric:
