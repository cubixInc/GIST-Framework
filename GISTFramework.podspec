...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/cubixlabs/GIST-Framework.git", :tag => "2.3" }
...
#sp.dependency 'IQKeyboardManagerSwift', '4.0.10'
   sp.dependency 'IQKeyboardManagerSwift', '~> 4.0.13'
